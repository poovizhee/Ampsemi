...
print(NI8452.ni845xSpiConfigurationOpen())
...
NI8452.ni845xSpiConfigurationSetNumBitsPerSample(24)
#NI8452.ni845xSpiConfigurationSetPort(0)

print(NI8452.ni845xSpiWriteRead(3, [0xAA, 0xFF, 0xFF], 2))

print(NI8452.ni845xSpiConfigurationClose())
