...
print(NI8452.ni845xSpiScriptOpen())
NI8452.ni845xSpiScriptEnableSPI()

NI8452.ni845xSpiScriptUsDelay(delay=0)
NI8452.ni845xSpiScriptClockPolarityPhase(clockpolarity=0, clockphase=0)
NI8452.ni845xSpiScriptClockRate(clockrate=20000)
NI8452.ni845xSpiScriptCSLow(chipselect=1)
NI8452.ni845xSpiScriptNumBitsPerSample(27)
NI8452.ni845xSpiScriptWriteRead(writesize=4, writedata=[0x55, 0xaa, 0x55, 0xaa], scriptreadindex=0)
NI8452.ni845xSpiScriptCSHigh(chipselect=1)
NI8452.ni845xSpiScriptRun(portnumber=0)

#NI8452.ni845xSpiScriptDisableSPI()
print(NI8452.ni845xSpiScriptClose())
