...
"""
NI8452 = SPIStream()
print(NI8452.ni845xOpen())
NI8452.ni845xSetIoVoltageLevel(12)
print(NI8452.ni845xSpiStreamConfigurationOpen())

NI8452.ni845xSpiStreamConfigurationSetNumSamples(numsamples=1)
NI8452.ni845xSpiStreamConfigurationSetNumBits(numbits=27)
NI8452.ni845xSpiStreamConfigurationSetClockPolarity(clockpolarity=1)
NI8452.ni845xSpiStreamConfigurationSetClockPhase(clockphase=1)
NI8452.ni845xSpiStreamConfigurationWave1SetTimingParam(timingparameter=0, ParameterValue=2)
NI8452.ni845xSpiStreamConfigurationWave1SetTimingParam(timingparameter=1, ParameterValue=2)
NI8452.ni845xSpiStreamConfigurationWave1SetTimingParam(timingparameter=8, ParameterValue=7)
NI8452.ni845xSpiStreamConfigurationWave1SetTimingParam(timingparameter=12, ParameterValue=1)
NI8452.ni845xSpiStreamConfigurationWave1SetMosiData(dataarray=[0x55,0xaa,0x55,0xaa], arraysize=5)
NI8452.ni845xSpiStreamConfigurationWave1SetPinConfig(pinnumber=2, mode=1)
NI8452.ni845xSpiStreamStart()
#NI8452.ni845xSpiStreamRead()
NI8452.ni845xSpiStreamStop()

print(NI8452.ni845xSpiStreamConfigurationClose())
print(NI8452.ni845xClose())
"""
