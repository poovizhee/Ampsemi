...
# a = Keithley2200()
# a.open("USB0::0x05E6::0x2200::9205873::INSTR", True, True)
# a.configure(output_voltage=2, output_current=0.1,beeper=1)
# a.output(1)
# # print(a.read_outputcurrent())
# print(a.read_outputvoltage())
# print(a.read_output())
# # print(a.read_functionmode())
# a.functionmode(mode=1)
# print(a.read_functionmode())
# a.close()
